<!-- Bootstrap CSS
		...
		<!-- nivo slider CSS
		============================================ -->
		<link rel="stylesheet" href="{{ asset('client/assets/lib/css/nivo-slider.css') }}" type="text/css" />
		<link rel="stylesheet" href="{{ asset('client/assets/lib/css/preview.css') }}" type="text/css" media="screen" />
		<!-- chosen CSS
		============================================ -->
        ...
        <link rel="stylesheet" href="{{ asset('client/assets/css/mystyles.css') }}">
